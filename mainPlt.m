...
for curStep = 2:nRuns
    ...
    if fixed == 1
        ...
        if norm(diff) > errTol
            switch(orderK)
                case 1
                    [cst,optPos,oP1] = ctrlOrder1Plt(pos, sampPos,particleWgt',varPos);
                case 2
                    [cst,optPos,oP1] = ctrlOrder2Plt(pos, sampPos,particleWgt',varPos);
                case size(pos,1)
                    [cst,optPos,oP1] = ctrlOrdernPlt(pos, sampPos,particleWgt',varPos);
                otherwise
